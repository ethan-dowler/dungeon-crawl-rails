RSpec.describe Modifier do
  ...
  describe "after_save/after_destroy hook" do
    before do
      ...
      character.modifiers.speed_rating.flat.create!(value: 10, source: character)
      ...
      character.update!(max_hp: 0, speed_rating: 0, armor_rating: 0, damage_rating: 0)
    end
    ...
    describe "when a modifier is changed" do
      it "recalculates all calculated fields" do
        ...
        expect(character.speed_rating).to eq(20)
